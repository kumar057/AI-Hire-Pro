...
const labels: Record<string, string> = { profile: 'Company Profile', 'post-job': 'Post Job', jobs: 'Manage Jobs', applicants: 'Applicants', interviews: 'Interviews', messages: 'Messages', notifications: 'Notifications', analytics: 'Analytics', subscription: 'Subscription', settings: 'Settings', help: 'Help' };
