...
export const COMPANY_NAV_ITEMS: CompanyNavItem[] = [
  ...
  { id: 'interviews', label: 'Interviews', to: '/company/dashboard/interviews', icon: FiCalendar },
  {
    ...
    to: '/company/dashboard/hiring-pipeline',
    icon: FiGitBranch,
  },
  {
    id: 'recruiter-notes',
    label: 'Recruiter Notes',
    to: '/company/dashboard/recruiter-notes',
    icon: FiEdit3,
  },
  {
    id: 'recruiter-team',
    label: 'Team Collaboration',
    to: '/company/dashboard/recruiter-team',
    icon: FiUsers,
  },
  {
    id: 'hiring-calendar',
    label: 'Hiring Calendar',
    to: '/company/dashboard/hiring-calendar',
    icon: FiCalendar,
  },
  ...
  { id: 'activity', label: 'Activity Feed', to: '/company/dashboard/activity', icon: FiActivity },
  { id: 'analytics', label: 'Analytics', to: '/company/dashboard/analytics', icon: FiBarChart2 },
  {
    id: 'subscription',
    label: 'Subscription',
    to: '/company/dashboard/subscription',
    icon: FiCreditCard,
  },
...
export const COMPANY_METRICS = [
  {
    key: 'total_jobs',
    label: 'Total Jobs',
    helper: 'All job posts',
    icon: FiBriefcase,
    tone: 'text-cyan-700 bg-cyan-50 dark:text-cyan-200 dark:bg-cyan-300/10',
  },
  {
    key: 'active_jobs',
    label: 'Active Jobs',
    ...
    icon: FiFilePlus,
    tone: 'text-emerald-700 bg-emerald-50 dark:text-emerald-200 dark:bg-emerald-300/10',
  },
  {
    key: 'applications',
    label: 'Applications',
    ...
    icon: FiUsers,
    tone: 'text-violet-700 bg-violet-50 dark:text-violet-200 dark:bg-violet-300/10',
  },
  {
    key: 'interviews',
    label: 'Interviews',
    ...
    icon: FiCalendar,
    tone: 'text-amber-700 bg-amber-50 dark:text-amber-200 dark:bg-amber-300/10',
  },
  {
    ...
    icon: FiUserCheck,
    tone: 'text-rose-700 bg-rose-50 dark:text-rose-200 dark:bg-rose-300/10',
  },
  {
    key: 'company_views',
    label: 'Company Views',
    helper: 'This month',
    icon: FiBarChart2,
    tone: 'text-blue-700 bg-blue-50 dark:text-blue-200 dark:bg-blue-300/10',
  },
] as const;
