...
export const COMPANY_NAV_ITEMS: CompanyNavItem[] = [
  ...
  { id: 'pipeline', label: 'Applicant Pipeline', to: '/company/dashboard/pipeline', icon: FiColumns },
  { id: 'candidates', label: 'Candidate Profiles', to: '/company/dashboard/candidates', icon: FiUserCheck },
  { id: 'interviews', label: 'Interviews', to: '/company/dashboard/interviews', icon: FiCalendar },
  { id: 'hiring-pipeline', label: 'Hiring Pipeline', to: '/company/dashboard/hiring-pipeline', icon: FiGitBranch },
  { id: 'recruiter-notes', label: 'Recruiter Notes', to: '/company/dashboard/recruiter-notes', icon: FiEdit3 },
  { id: 'recruiter-team', label: 'Team Collaboration', to: '/company/dashboard/recruiter-team', icon: FiUsers },
  { id: 'hiring-calendar', label: 'Hiring Calendar', to: '/company/dashboard/hiring-calendar', icon: FiCalendar },
